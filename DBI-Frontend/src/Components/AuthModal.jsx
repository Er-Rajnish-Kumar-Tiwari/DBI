      ...
      <div className="w-full max-w-sm bg-white dark:bg-[#0a225e] border border-[#2D4F9E]/30 rounded-xl p-6 shadow-xl">
        ...
        <form onSubmit={onSubmit} className="flex flex-col gap-4">
          ...
          <button
            ...
            className="w-full py-2 mt-2 text-white text-sm rounded-md bg-gradient-to-r from-[#A456F7] to-[#3D81F6] hover:from-[#CDA1FF] hover:to-[#80609F] disabled:opacity-50 cursor-pointer"
          >
